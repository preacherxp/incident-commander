...
const LINES: Record<VoiceCue, string[]> = {
  ...
  threat_blocked: [
    "Fine. You read that one.",
    "Enjoy the small win.",
    "One counter is not a strategy.",
  ],
  player_ahead: [
    "Comfortable? Good.",
  ...
  jev_ahead: [
    "Momentum is mine.",
    "The graph is bending my way.",
    "You are reacting now. I prefer that.",
  ],
  draft: [
...
export function fallbackLine(request: VoiceRequest): string {
